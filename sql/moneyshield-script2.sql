CREATE DATABASE  IF NOT EXISTS `moneyshield1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `moneyshield1`;
...
(1,'Juan','Pérez','juan@perez.com','2830049',2,500.00,100.00,'2025-05-13 05:30:26'),
(2,'Ana','López','ana@lopez.com','9221040',2,600.00,150.00,'2025-05-13 05:30:26'),
(3,'Carlos','García','carlos@garcia.com','4781441',1,700.00,200.00,'2025-05-13 05:30:26'),
(4,'Emmanuel','Pallares','emmanuel@moneyshield.com','1234567',1,500.00,100.00,'2025-05-13 05:30:26'),
(5,'Franyi','López','franyi@moneyshield.com','2345678',2,600.00,150.00,'2025-05-13 05:30:26'),
(6,'Ydalina','Tejada','ydalina@moneyshield.com','3456789',2,700.00,200.00,'2025-05-13 05:30:26'),
(7,'Rosa','Meltrozo','roza.meltrozo@gmail.com','7062217',2,800.00,150.00,'2025-05-13 07:47:39');
...
(1,1,2,NULL,50.00,'Dinner at restaurant','2025-05-13 05:30:26'),
(2,1,1,NULL,1200.00,'Monthly paycheck','2025-05-13 05:30:26'),
(3,1,2,NULL,30.00,'Taxi to work','2025-05-13 05:30:26'),
(4,2,1,NULL,1500.00,'Monthly payment','2025-05-13 05:30:26'),
(5,2,2,NULL,100.00,'Supermarket shopping','2025-05-13 05:30:26'),
(6,2,2,NULL,20.00,'Cinema','2025-05-13 05:30:26'),
(7,3,1,NULL,2000.00,'Web project','2025-05-13 05:30:26'),
(8,3,2,NULL,150.00,'New headphones','2025-05-13 05:30:26'),
(9,4,1,NULL,1500.00,'January salary','2025-05-13 05:30:26'),
(10,4,2,NULL,200.00,'January rent','2025-05-13 05:30:26'),
(11,5,1,NULL,1600.00,'Web project payment','2025-05-13 05:30:26'),
(12,5,2,NULL,100.00,'Electricity bill','2025-05-13 05:30:26'),
(13,6,1,NULL,1700.00,'January profits','2025-05-13 05:30:26'),
(14,6,2,NULL,300.00,'Dental appointment','2025-05-13 05:30:26');
...
(1,4,1,2025,1,1000.00,'January monthly budget for Emmanuel','2025-05-13 05:30:26'),
(2,5,1,2025,1,1200.00,'January monthly budget for Franyi','2025-05-13 05:30:26'),
(3,6,1,2025,1,1500.00,'January monthly budget for Ydalina','2025-05-13 05:30:26'),
(4,4,1,2025,0,12000.00,'Annual budget for Emmanuel','2025-05-13 05:30:26'),
(5,5,1,2025,0,14000.00,'Annual budget for Franyi','2025-05-13 05:30:26'),
(6,6,1,2025,0,16000.00,'Annual budget for Ydalina','2025-05-13 05:30:26'),
(7,4,2,2025,1,300.00,'January food budget for Emmanuel','2025-05-13 05:30:26'),
(8,5,3,2025,1,500.00,'January housing budget for Franyi','2025-05-13 05:30:26'),
(9,6,4,2025,1,200.00,'January health budget for Ydalina','2025-05-13 05:30:26');
...
(1,4,1,'Emergency Fund',100.00,'Monthly saving for emergencies','2025-05-13 05:30:26',NULL),
(2,4,2,'Vacation Fund',50.00,'Extra saving for summer trip','2025-05-13 05:30:26',NULL),
(3,5,1,'Tech Upgrade',200.00,'Monthly saving for new laptop','2025-05-13 05:30:26',NULL),
(4,5,2,'Birthday Gift',30.00,'Gift for friend','2025-05-13 05:30:26',NULL),
(5,6,1,'Medical Fund',300.00,'Reserved for health emergencies','2025-05-13 05:30:26',NULL),
(6,6,2,'Business Expansion',100.00,'Saved for marketing','2025-05-13 05:30:26',NULL);
...
BEGIN
    ...
    -- For example:
    UPDATE transactions SET category_id = 2 WHERE category_id IS NULL  -- food category
        AND (description LIKE '%restaurant%' OR description LIKE '%food%' OR description LIKE '%meal%');
    
    UPDATE transactions SET category_id = 3 WHERE category_id IS NULL /* housing para servicio de renta  */
        AND (description LIKE '%rent%' OR description LIKE '%house%' OR description LIKE '%apartment%');
    
    UPDATE transactions SET category_id = 4 WHERE category_id IS NULL -- savings doctor
        AND (description LIKE '%doctor%' OR description LIKE '%medical%' OR description LIKE '%healthcare%');
