...
class Validador {
    ...
    public static boolean validarDNI(String dni) {
        if (dni == null || !PATRON_DNI.matcher(dni).matches()) return false;
...
public class FormularioRegistro extends JFrame {
    ...
    public FormularioRegistro() {
        ...
        campoNombre = new CampoRegistro("Nombre");
        campoApellidos = new CampoRegistro("Apellidos");
        campoDNI = new CampoRegistro("DNI");
        campoCorreo = new CampoRegistro("Correo Electrónico");
        campoDireccion = new CampoRegistro("Dirección");
        campoTelefono = new CampoRegistro("Teléfono");
    ...
    private static class CampoRegistro {
         ...
         */
        public CampoRegistro(String texto) {
